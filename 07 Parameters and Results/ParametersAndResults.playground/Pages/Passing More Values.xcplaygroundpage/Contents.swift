...
func hello2 (firstName: String, lastName: String) {
    print("Hello \(firstName) \(lastName)")
}
hello2(firstName: "Rashed", lastName: "Almajed")
hello2(firstName: "Haifa", lastName: "Wahbi ")
hello2(firstName: "Nancy", lastName: "Ajram")
