...
func hello1(favoriteCelebrities: String, lastName: String) {
    print("Hello \(favoriteCelebrities) \(lastName)")
}
hello(firstName: "moh", lastName: "alarify")
hello(firstName: "huda", lastName: "hsen")
