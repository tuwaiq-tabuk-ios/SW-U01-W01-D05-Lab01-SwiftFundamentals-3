...
let sentence1 = makeFavorite(categoryOfThing:"movie", favorite:"minimalism")
let sentence2 = makeFavorite(categoryOfThing:"school", favorite:"PNU")
...
print("Hello, my name is mona. \(sentence ), \(sentence1 ) and \(sentence2 ) ")
