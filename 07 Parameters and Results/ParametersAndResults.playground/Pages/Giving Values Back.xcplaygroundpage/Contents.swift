...
let sentence = makeFavorite(categoryOfThing: "food", favorite: "pasta")

print(sentence)


print("\n\n ------------ Experiment 1 ------------")
func makeFavorite(movies: String,
                  favorite: String) -> String {
  return "My favorite \(movies) is \(favorite)"
}

let sentence1 = makeFavorite(movies: "movies", favorite: "the dream")
...
let sentence3 = "Hello, my name is Bushra. \(sentence) \(sentence1) ..."
print(sentence3)
