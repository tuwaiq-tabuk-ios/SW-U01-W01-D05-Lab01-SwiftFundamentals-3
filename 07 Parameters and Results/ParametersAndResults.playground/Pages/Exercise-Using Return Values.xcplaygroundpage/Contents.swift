...
let sentence = impossibleBeliefsCount(pigsFlying: 1, frogsBecomingPrinces: 2, multipleLightningStrikes: 1)

let Sentence = impossibleThingsPhrase(numberOfImpossibleThings: sentence , meal: "teatime")
